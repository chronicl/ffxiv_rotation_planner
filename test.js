const rotationd = [{
  ...
  const setRotationWithTimeline = (rotations, rotationToCopy, setRotations, rotationID) => {
    const rotation = [...rotationToCopy]
    ...
    newRotations[rotationID] = rotationWithTimeline
    console.log(newRotations)
  }

const rotations = [[]]
const ha = {really: true? "hello" : "this"}
console.log(ha)